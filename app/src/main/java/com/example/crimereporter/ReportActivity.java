...
public class ReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextaddress = (EditText)findViewById(R.id.reportAddressEditText);
        editTextcity = (EditText)findViewById(R.id.cityEditText);
        editTextpincode = (EditText)findViewById(R.id.pincodeEditText);
        editTextdetails = (EditText)findViewById(R.id.reportDetailsEditText);
        editTextsubject = (EditText)findViewById(R.id.subjectEditText);
        report = (Button)findViewById(R.id.reportSubmitButton);
        ...
        report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(CheckEditText){
                    ...
                    Toast.makeText(ReportActivity.this, "Please Fill all the fields", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void ReportCrimeFunction(final String Address, final String City,
        ...
        class ReportCrimeFunctionClass extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String httpResponseMsg){
                ...
                Toast.makeText(ReportActivity.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
            }
